...
const TravelPoint = () => {
  return (
    <section className='relative max-container padding-container py-20 flex xs:flex-col md:flex-row items-end'>
      <Image 
        className='absolute z-30 xs:bottom-[60%] md:bottom-[5%] md:left-[-5%] lg:left-[5%] xs:w-[500px] xs:h-[500px] md:w-[570px] md:h-[570px] lg:w-[650px] lg:h-[650px]' 
        src='/person.png' 
        alt='person' 
        width={650} 
        height={700}
      ...
      <div className='relative md:w-[35%] xs:w-full flex flex-col gap-12'>
        <div className='top flex flex-col gap-8'>
          ...
          <p className='text-lg opacity-50'>We have an amazing collection of hotels and accommodations too</p>   
        </div>
