  ...
  return (
    <section className='relative max-container padding-container flex flex-col gap-16 py-15 pt-4'>
      ...
      <div className='bottom flex items-center justify-between'>
        ...
        >
          {[
            { img: '/rift.jpg', place: 'The Great Rift Valley', country: 'Nairobi, Kenya', price: '$550.16', rating: '4.8', url: destinationUrls['The Great Rift Valley'] },
            { img: '/2.jpg', place: 'Giraffe Centre Nairobi', country: 'Nairobi, Kenya', price: '$20.99', rating: '4.5', url: destinationUrls['Giraffe Centre Nairobi'] },
            { img: '/crater.jpg', place: 'Menengai Crater View Point', country: 'Nakuru, Kenya', price: '$150.99', rating: '5.0', url: destinationUrls['Menengai Crater View Point'] },
            { img: '/kenya.jpg', place: 'Mount Kenya', country: 'Central, Kenya', price: '$750.00', rating: '4.8', url: destinationUrls['Mount Kenya'] },
            { img: '/9.jpg', place: 'Pyramids of Giza', country: 'Giza, Egypt', price: '$670.50', rating: '4.6', url: destinationUrls['Pyramids of Giza'] }
...
const DestinationCard = ({ img, place, country, price, rating, url }) => {
  return (
