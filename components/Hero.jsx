  ...
  return (
    <section className='relative max-container padding-container xs:py-12 sm:py-28 xs:gap-16 sm:gap-32 gap-0 flex flex-col xl:flex-row'>
      ...
      <div className='relative z-2 flex flex-1 text-center flex-col gap-8 xl:w-2/5'>
        <h1 className='md:text-6xl xs:text-4xl font-semibold'>
          WELCOME <br /> TO <span className='text-[crimson]'> AFRICA</span>
        </h1>
        <p className='text-opacity-50 text-xl'>To the continent that prides itself from its culture, heritage, and people</p>
      ...
      {/* RIGHT */}
      <div className='relative z-1 xl:w-3/5 flexCenter flex-1'>
